...
function ActionsCell({ id, name, updator, deleter }: Props): JSX.Element {
  ...
  return (
    <div className='flex gap-4'>
		<MutationDialog dataId={id} mutator={updator} triggerButtonVariant="ghost" description={`Change the name of ${name}. Click save when you're done.`} {...UpdateUserDialogProps} />
